...
for (minparent in minparents) {
    ...
    g_noise=Urerf(hw_noise_data, trees = 300, min.parent=minparent, Progress = TRUE, LinearCombo=FALSE, splitCrit = "bicfast", normalizeData = FALSE)
...
save(main_list, minparents, at_K, file= paste(experiment, data, "version3_varying_dims_vary_minparent.Rdata", sep="_"))
