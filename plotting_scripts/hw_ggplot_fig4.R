...
load("rotation_linear_varying_dims_with_flann_normalized.Rdata")
...
load("normalization_mog_varying_dims_with_flann_normalized.Rdata")
...
load("rotation_sphere_varying_dims_with_flann_normalized.Rdata")
...
load("normalization_helix_varying_dims_with_flann_normalized.Rdata")
...
ggsave("final_plots/varying_dim_adele_with_euc_flann_normalized.png")
#plot(p)
